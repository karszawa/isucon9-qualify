...
func main() {
	...
	mux.HandleFunc(pat.Get("/users/transactions.json"), getTransactions2)
...
func getShipmentServiceURL() string {
	defer measure.Start("getShipmentServiceURL").Stop()
...
func getTransactions2(w http.ResponseWriter, r *http.Request) {
	defer measure.Start("getTransactions").Stop()
...
func postSell(w http.ResponseWriter, r *http.Request) {
	defer measure.Start("postSell").Stop()
